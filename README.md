...
Open a command line on your computer and run the command cd path/to/project/root, which allows you to point to the root folder of the  files (note that path/to/project/root should be replaced with the actual path to the starter files)
